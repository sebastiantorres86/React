...
Para evitar esto, tenemos que usar en los métodos la sintaxis de propiedad de clase, junto a la de funciones de flecha. Es decir, asignarle una propiedad de la clase función, es decir:
