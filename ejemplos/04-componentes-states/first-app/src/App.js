...
class App extends Component {
  ...
  constructor(props) {
    ...
    // La propiedad SIEMPRE tiene que llamarse state, y el objeto puede tener cualquier cantidad y tipo de porpiedades
    this.state = {
      nombre: "Ada Lovelace",
    };
  }
  render() {
    ...
    return (
      <div>
        {/* Para mostrar una propiedad del estado, siempre con 'this.state' y el nombre de la propiedad que queremos ver */}
